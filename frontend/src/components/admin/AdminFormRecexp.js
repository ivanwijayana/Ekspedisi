...
function AdminFormRecexp(){
    ...
    const saveRecexp = async (e) => {
        e.preventDefault();
        await axios.post('http://localhost:3010/recexp', {
            id_barang: idbarang,
                ...
                <div className="col-lg-8">
                    <div className="card">
                        ...
                        <div className="card-body card-block">
                            <form className="form-horizontal" onSubmit={saveRecexp}>
...
export default AdminFormRecexp;
