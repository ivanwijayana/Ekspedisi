...
function AdminEditRecuser(){
    ...
    function UpdateRecuser(e) {
        e.preventDefault();
        try{axios.put(`http://localhost:3010/recuser/${id}`, data).then(navigate("/recuser"));}
        catch (error){
            alert(error)
        }
    }
            ...
            <div className="col-lg-8">
                <div className="card">
                    ...
                    <div className="card-body card-block">
                        <form className="form-horizontal" onSubmit={UpdateRecuser}>
